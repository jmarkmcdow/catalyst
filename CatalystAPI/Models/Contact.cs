...
namespace CatalystAPI.Models
{
    ...
    {
        public Volunteer(string firstname, string lastname, string comments, short age, Address address, string occupation, string business, int id = 0): base(firstname, lastname, comments, age, address, occupation, business, id)
        {}
    }
}
